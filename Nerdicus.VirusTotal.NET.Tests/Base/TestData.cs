...
namespace Nerdicus.VirusTotalNET.Tests.Base
{
    internal static class TestData
    {
        ...
        internal static readonly string[] KnownUrls = { "http://google.de", "http://google.com", "https://virustotal.com" };
        internal static readonly string[] KnownIPv4s = { "1.1.1.1", "8.8.8.8", "8.8.4.4", "216.58.211.142" }; //Google DNS and Google.com
        ...
        internal static IEnumerable<string> GetUnknownIPv4s(int count)
        {
            for (int i = 0; i < count; i++)
            {
                var d = new IPAddress(BitConverter.GetBytes(i).Reverse().ToArray());
