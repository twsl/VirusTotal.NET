...
namespace Nerdicus.VirusTotalNET.Helpers
{
    public static class ResourcesHelper
    {
        ...
        public static string GetResourceIdentifier(string url)
        {
            ...
            {
                throw new UriFormatException($"The url '{url}' is in the wrong format");
            }
        ...
        public static IEnumerable<string> ValidateResourcea(IEnumerable<string> resources, ResourceType type)
        {
            ...
            {
                yield return ValidateResources(resource, type);
            }
        }

        public static string ValidateResources(string resource, ResourceType type)
        {
            ...
            if (!valid)
            {
                throw new InvalidResourceException($"Resource '{resource}' has the wrong ResourceType.");
            }
        ...
        public static string NormalizeUrl(string url, bool useTls = true)
        {
